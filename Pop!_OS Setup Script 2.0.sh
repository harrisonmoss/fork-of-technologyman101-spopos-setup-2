...
do
	clear # clear screen for each loop of menu
 	tput setaf 3
	echo "============================================"
	echo " --- Pop!_OS Setup Script 2.0 Main Menu ---"
	echo "============================================"
